...
/********************Changed 4 Efren**********************/
    AddString(net, "network.interface",775,"", SPIN_CONTROL_TEXT);
    AddInt(net, "network.assignment", 715, NETWORK_DHCP, NETWORK_DHCP, 1, NETWORK_DISABLED, SPIN_CONTROL_TEXT);
    ...
    AddString(net, "network.essid", 776, "0.0.0.0", BUTTON_CONTROL_STANDARD);
    AddInt(net, "network.enc", 778, ENC_NONE, ENC_NONE, 1, ENC_WPA2, SPIN_CONTROL_TEXT);
    AddString(net, "network.key", 777, "0.0.0.0", EDIT_CONTROL_HIDDEN_INPUT);
    AddString(net, "network.save", 779, "", BUTTON_CONTROL_STANDARD);
/**********************************************/
