...
static CProfile emptyProfile2;

CStdString CSettings::GetProfileThumbnailsFolder() const
{
  //CStdString folder;
  //CUtil::AddFileToFolder("/home/efernandez/","Desktop",folder);

  //return folder;
  return m_vecProfiles[0].getThumb();
}
...
CStdString CSettings::GetThumbnailsFolder() const
{
  CStdString folder;
  //if (GetCurrentProfile().hasDatabases())
    CUtil::AddFileToFolder(GetProfileThumbnailsFolder(), "Thumbnails", folder);
  //else
  //  CUtil::AddFileToFolder(GetUserDataFolder2(), "Thumbnails", folder);
...
CStdString CSettings::GetMusicThumbFolder() const
{
  CStdString folder;
  //if (GetCurrentProfile().hasDatabases())
    CUtil::AddFileToFolder(GetProfileThumbnailsFolder(), "Thumbnails/Music", folder);
 // else
  //  CUtil::AddFileToFolder(GetUserDataFolder2(), "Thumbnails/Music", folder);
...
CStdString CSettings::GetLastFMThumbFolder() const
{
  CStdString folder;
 // if (GetCurrentProfile().hasDatabases())
    CUtil::AddFileToFolder(GetProfileThumbnailsFolder(), "Thumbnails/Music/LastFM", folder);
 // else
   // CUtil::AddFileToFolder(GetUserDataFolder2(), "Thumbnails/Music/LastFM", folder);
...
CStdString CSettings::GetMusicArtistThumbFolder() const
{
  CStdString folder;
  //if (GetCurrentProfile().hasDatabases())
    CUtil::AddFileToFolder(GetProfileThumbnailsFolder(), "Thumbnails/Music/Artists", folder);
  //else
    //CUtil::AddFileToFolder(GetUserDataFolder2(), "Thumbnails/Music/Artists", folder);
...
CStdString CSettings::GetVideoThumbFolder() const
{
  CStdString folder;
  //if (GetCurrentProfile().hasDatabases())
    CUtil::AddFileToFolder(GetProfileThumbnailsFolder(), "Thumbnails/Video", folder);
  //else
   // CUtil::AddFileToFolder(GetUserDataFolder2(), "Thumbnails/Video", folder);
...
CStdString CSettings::GetVideoFanartFolder() const
{
  CStdString folder;
  //if (GetCurrentProfile().hasDatabases())
    CUtil::AddFileToFolder(GetProfileThumbnailsFolder(), "Thumbnails/Video/Fanart", folder);
 // else
  //  CUtil::AddFileToFolder(GetUserDataFolder2(), "Thumbnails/Video/Fanart", folder);
...
CStdString CSettings::GetMusicFanartFolder() const
{
  CStdString folder;
  //if (GetCurrentProfile().hasDatabases())
    CUtil::AddFileToFolder(GetProfileThumbnailsFolder(), "Thumbnails/Music/Fanart", folder);
 // else
  //  CUtil::AddFileToFolder(GetUserDataFolder2(), "Thumbnails/Music/Fanart", folder);
...
CStdString CSettings::GetBookmarksThumbFolder() const
{
  CStdString folder;
  //if (GetCurrentProfile().hasDatabases())
    CUtil::AddFileToFolder(GetProfileThumbnailsFolder(), "Thumbnails/Video/Bookmarks", folder);
  //else
   // CUtil::AddFileToFolder(GetUserDataFolder2(), "Thumbnails/Video/Bookmarks", folder);
