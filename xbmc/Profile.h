...
public:
  ...
  //const CStdString& getDirectoryThumbnails() const { return m_directoryThumbnails;}
  ...
  //void setDirectoryThumbnails(const CStdString& directory) {m_directoryThumbnails = directory;}
...
private:
  ...
  CStdString m_directoryThumbnails;
  CStdString m_name;
  CStdString m_date;
  CStdString m_thumb;
  bool m_bDatabases;
